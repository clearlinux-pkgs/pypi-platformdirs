...
Source0  : https://files.pythonhosted.org/packages/11/39/702094fc1434a4408783b071665d9f5d8a1d0ba4dddf9dadf3d50e6eb762/platformdirs-3.0.0.tar.gz
...
%prep
%setup -q -n platformdirs-3.0.0
cd %{_builddir}/platformdirs-3.0.0
pushd ..
cp -a platformdirs-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675734242
