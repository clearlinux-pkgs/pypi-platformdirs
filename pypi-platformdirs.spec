...
Source0  : https://files.pythonhosted.org/packages/8f/5f/01180534cebac14f3a792bf2f74fc99d34531c950c308fdebd9721e85550/platformdirs-3.1.0.tar.gz
...
%prep
%setup -q -n platformdirs-3.1.0
cd %{_builddir}/platformdirs-3.1.0
pushd ..
cp -a platformdirs-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677976363
