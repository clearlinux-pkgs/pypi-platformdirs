...
Source0  : https://files.pythonhosted.org/packages/47/73/046da71a75870bbcc0469e2ea71b56ffc865e2b4b39337754e8fdb516028/platformdirs-2.5.0.tar.gz
...
%prep
%setup -q -n platformdirs-2.5.0
cd %{_builddir}/platformdirs-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644434313
...
cp %{_builddir}/platformdirs-2.5.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-platformdirs/1a628675f3f38f1d4715ebd772a8160a0ea94dd4
