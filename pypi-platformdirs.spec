...
Source0  : https://files.pythonhosted.org/packages/79/c4/f98a05535344f79699bbd494e56ac9efc986b7a253fe9f4dba7414a7f505/platformdirs-3.1.1.tar.gz
...
%prep
%setup -q -n platformdirs-3.1.1
cd %{_builddir}/platformdirs-3.1.1
pushd ..
cp -a platformdirs-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678720785
