...
Source0  : https://files.pythonhosted.org/packages/96/dc/c1d911bf5bb0fdc58cc05010e9f3efe3b67970cef779ba7fbc3183b987a8/platformdirs-4.2.0.tar.gz
...
%prep
%setup -q -n platformdirs-4.2.0
cd %{_builddir}/platformdirs-4.2.0
pushd ..
cp -a platformdirs-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706719621
