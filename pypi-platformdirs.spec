...
%prep
%setup -q -n platformdirs-2.5.1
cd %{_builddir}/platformdirs-2.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645303917
...
cp %{_builddir}/platformdirs-2.5.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-platformdirs/1a628675f3f38f1d4715ebd772a8160a0ea94dd4
