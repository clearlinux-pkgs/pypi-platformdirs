...
Source0  : https://files.pythonhosted.org/packages/fe/8b/3c73abc9c759ecd3f1f7ceff6685840859e8070c4d947c93fae71f6a0bf2/platformdirs-4.3.8.tar.gz
...
%prep
%setup -q -n platformdirs-4.3.8
cd %{_builddir}/platformdirs-4.3.8
pushd ..
cp -a platformdirs-4.3.8 buildavx2
popd
pushd ..
cp -a platformdirs-4.3.8 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746714509
