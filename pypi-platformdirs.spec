...
Source0  : https://files.pythonhosted.org/packages/cb/5f/dda8451435f17ed8043eab5ffe04e47d703debe8fe845eb074f42260e50a/platformdirs-2.5.4.tar.gz
...
%prep
%setup -q -n platformdirs-2.5.4
cd %{_builddir}/platformdirs-2.5.4
pushd ..
cp -a platformdirs-2.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448705
