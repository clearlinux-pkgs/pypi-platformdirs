...
Source0  : https://files.pythonhosted.org/packages/ec/4c/9af851448e55c57b30a13a72580306e628c3b431d97fdae9e0b8d4fa3685/platformdirs-2.6.0.tar.gz
...
%prep
%setup -q -n platformdirs-2.6.0
cd %{_builddir}/platformdirs-2.6.0
pushd ..
cp -a platformdirs-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670498187
