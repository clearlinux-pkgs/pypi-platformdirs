...
Source0  : https://files.pythonhosted.org/packages/31/28/e40d24d2e2eb23135f8533ad33d582359c7825623b1e022f9d460def7c05/platformdirs-4.0.0.tar.gz
...
%prep
%setup -q -n platformdirs-4.0.0
cd %{_builddir}/platformdirs-4.0.0
pushd ..
cp -a platformdirs-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699896904
